...
class _CourseDetailScreenState extends State<CourseDetailScreen> {
  ...
  final List<Map<String, dynamic>> _materials = [
    {
      'meeting': 'Pertemuan 1',
      'title': '01 - Pengantar Kecerdasan Buatan',
      'description': '3 URLs, 2 Files',
      'isCompleted': false,
    },
    {
      'meeting': 'Pertemuan 2',
      'title': '02 - Represensi Pengetahuan',
      'description': '2 URLs, 1 Kuis',
      'isCompleted': true,
    },
    {
      'meeting': 'Pertemuan 3',
      'title': '03 - Sistem Pakar',
      'description': '3 URLs, 2 Files',
      'isCompleted': true,
    },
    {
      'meeting': 'Pertemuan 4',
      'title': '04 - Logika Fuzzy',
      'description': '3 URLs, 2 Files',
      'isCompleted': true,
    },
    {
      'meeting': 'Pertemuan 5',
      'title': '05 - Jaringan Saraf Tiruan',
      'description': '3 URLs, 2 Files',
      'isCompleted': true,
    },
    {
      'meeting': 'Pertemuan 6',
      'title': '06 - Algoritma Genetik',
      'description': '3 URLs, 2 Files',
      'isCompleted': true,
    },
  ];
  ...
  final List<Map<String, dynamic>> _tasks = [
    {
      'type': 'Tugas',
      'title': 'Tugas 01',
      'deadline': 'Jumat, 5 November 2025, 23:59 WIB',
      'status': 'Selesai',
    ...
    },
    {
      ...
      'deadline': 'Jumat, 21 November 2025, 23:59 WIB',
      'status': 'Selesai',
      'statusColor': Colors.green,
    },
    {
      'type': 'Tugas',
      'title': 'Tugas 02 - logika Fuzzy',
      'deadline': 'Jumat, 31 Desember 2025, 23:59 WIB',
